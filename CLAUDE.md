...
## 현재 단계: v0.3
범위: 원리별 산업 사례(FR-09, DESIGN.md 5.3 `cases`), 영어 README 사례 보강, 공식 Plugin Directory 제출 준비. v0.1·v0.2 흐름은 유지.
구현 순서: DESIGN.md 11.4 체크리스트를 위에서부터 순서대로.
...
- 작업 완료 시 DESIGN.md 11.4 체크박스 갱신.
